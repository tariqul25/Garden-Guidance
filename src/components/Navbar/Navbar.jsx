...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="navbar  shadow-sm w-11/12 mx-auto bg-[#4CAF50]">
        ...
        <div className="navbar-center hidden lg:flex">
          <nav className="menu menu-horizontal px-1 gap-4">
            ...
            <NavLink to='/vvfg'>Share a Garden Tip</NavLink>
            <NavLink to='/fgs'>Explore Gardeners</NavLink>
            <NavLink to='/sdfgd'>My Tips</NavLink>
            <p><li onClick={handlePassSignOut}>SignOut</li></p>
          </nav>
        </div>
